 ...
 * @author josemanuque
 */
public class SimulationWindowDesign extends javax.swing.JFrame {
    DefaultTableModel optModel = new DefaultTableModel(); 
    DefaultTableModel algModel = new DefaultTableModel(); 
    private final Map<Integer, Color> rowColors = new HashMap<>();
    List<PageComponent> componentsRamList;
    /**
     * Creates new form SimulationWindow
     */
    public SimulationWindowDesign() {
        String [] columnNames = {"Page ID", "PID", "Loaded", "L-Addr", "M-Addr", "D-Addr", "Loaded-T", "Mark"};
        optModel.setColumnIdentifiers(columnNames);
        algModel.setColumnIdentifiers(columnNames);
        initComponents();
        addRows();
        addRam();
        componentsRamList.get(0).setColor(null);
    }
    
    private void addRamComponent(){
        
    }
    
    private void addRows(){
        for (int i = 0; i < 50; i++){
            optModel.addRow(new Object[]{null, null, null, null, null, null, null, null});
        }
        // Establecer el color de fondo de la fila 0 en la tabla optModel
//        int rowIndex = 0;
//        Color rowColor = Color.YELLOW;
//        setRowColor(optModel, rowIndex, rowColor);
//
//        // Establecer el color de fondo de la fila 5 en la tabla optModel
//        int rowIndex2 = 5;
//        Color rowColor2 = Color.GREEN;
//        setRowColor(optModel, rowIndex2, rowColor2);
    }
    ...
    private void addRam(){
        ...
        int pageComponentWidth = panelWidth / 100;

        int x = 0;
        int y = 0;
        // Lista para almacenar las instancias de PageComponent
        componentsRamList = new ArrayList<>();
        for (int i = 0; i < 100; i++) {
            x = x + pageComponentWidth;
            System.out.println(x);

            PageComponent pageComponent = new PageComponent(pageComponentWidth, panelHeight);
            pageComponent.setBounds(x, y, pageComponentWidth, panelHeight);
            Random rand = new Random();
        int r = rand.nextInt(256);
        int g = rand.nextInt(256);
        int b = rand.nextInt(256);
        
        pageComponent.setColor(new Color(r, g, b));
            //componentsRamList.add(pageComponent);
            jPanelOPT.add(pageComponent);
        ...
        pageComponent.setColor(null);
            componentsRamList.add(pageComponent);
            jPanelAlg.add(pageComponent);
            
        }
    }
    
//    private void addRow(Object[] row, Color c){
//        for (int i = 0; i < 50; i++){
//            optModel.addRow(new Object[]{null, null, null, null, null, null, null, null});
//        }
//        // Establecer el color de fondo de la fila 0 en la tabla optModel
...
//    }
//    
//    private void setRowColor(DefaultTableModel model, int rowIndex, Color color) {
//        // Configurar el renderizador personalizado
//        TableOPT.setDefaultRenderer(Object.class, new TableCellRenderer(rowColors));
//
//        // Asignar el color de fondo de la fila
//        rowColors.put(rowIndex, color);
//
...
//    }
    ...
    private void initComponents() {
        ...
        TableALG = new javax.swing.JTable();
        jScrollPane2 = new javax.swing.JScrollPane();
        TableOPT = new javax.swing.JTable();
        ...
        TableALG.setModel(algModel);
        jScrollPane1.setViewportView(TableALG);

        TableOPT.setModel(optModel);
        jScrollPane2.setViewportView(TableOPT);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SimulationWindowDesign().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable TableALG;
    private javax.swing.JTable TableOPT;
